...
public class Programa {
	...
	public static void main(String... args) {
		...
		Academico a = new Academico(54264, "Antônio");
		Academico c = new Academico(42149, "Cláudia");
		Set<Academico> academicos = new HashSet<>();
		academicos.add(m);
		academicos.add(a);
		academicos.add(c);
		Disciplina php = new Disciplina("PHP");
		Disciplina java = new Disciplina("Java");
		...
		for (Academico acad : academicos) {
			System.out.println("Disciplinas do(a) " + acad);
			acad.mostraDisciplinas();
		}
	...
	/*
	 * 
	 * public static void velho(String[] args) { //Começa aqui System.out.println
	 * ("Boa noite pessoal !");
	 * 
	 * Ventilador ventiladorDoMunif,outroVentilador,v; ventiladorDoMunif=new
	 * Ventilador(); outroVentilador=new Ventilador();
	 * 
	 * v=ventiladorDoMunif;
	 * 
	 * Ventilador vt=new Ventilador();
	 * 
	 * ventiladorDoMunif.velocidade=1; outroVentilador.velocidade=2;
	 * 
	 * System.out.println ("Outro:"+outroVentilador.velocidade); System.out.println
	 * ("Munif:"+ ventiladorDoMunif.velocidade); //explicar Sobrecarga
	 * System.out.println ("V:"+v.velocidade); //explicar Sobrecarga v.velocidade=5;
	 * System.out.println ("Munif:"+ ventiladorDoMunif.velocidade); //explicar
	 * Sobrecarga System.out.println ("V:"+v.velocidade); //explicar Sobrecarga
	 * 
	 * System.out.println(ventiladorDoMunif); System.out.println(v);
